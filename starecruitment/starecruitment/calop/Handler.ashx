...
public class Handler : IHttpAsyncHandler
{
    ...
    private static readonly string FILES_PATH = System.Web.HttpContext.Current.Request.PhysicalApplicationPath+@"Uploader";
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        else if (context.Request.HttpMethod.ToUpper() == HttpMethods.POST)
        {
            ...
            for (int FileIndex = 0; FileIndex < context.Request.Files.Count; FileIndex++)
            {
                ...
                FileResponseList.Add(CreateFileResponse(context.Request, Path.GetFileName(FileName), File.ContentLength, ErrorMessage));
            }
